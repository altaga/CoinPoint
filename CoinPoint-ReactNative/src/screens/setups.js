...
import splash from "../assets/splash_icon.png"
// Styles
            ...
            <View style={GlobalStyles.containerSetup}>
                {
                    this.state.stage === 0 &&
                    <>
                        <Image source={splash} style={{ height: 749 / 4, width: 648 / 3 }} />
                    </>
                }
                {
                    this.state.stage === 1 &&
                ...
                }
                {
                    ...
                    <>
                        <View style={{ height: "10%" }} />
                        <Icon name="shield-alt" size={128} color={"#0052FE"} />
                        <Text style={{ textAlign: "center", width: "80%", fontSize: 24, fontFamily: "Helvetica", color: "black" }}>
                            Protect POS {"\n"}with a pincode
                        </Text>
                        <Pressable style={[GlobalStyles.button]} onPress={() => this.setState({
                ...
                }
                {
                    ...
                    <>
                        ...
                        <View style={{ backgroundColor: "white", borderColor: "#0052FE", borderWidth: 1, width: "90%", height: "30%", flexDirection: "row", justifyContent: "space-around", flexWrap: "wrap" }}>
                            {
                                ["", "", ""].map((item, index) => {
                                    return (
