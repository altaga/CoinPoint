        ...
        return (
            <View style={[GlobalStyles.footer, { flexDirection: "row", justifyContent: "space-evenly", alignItems: "center", borderTopWidth: 2, borderColor: headerColor }]}>
                <Pressable style={[this.context.value.selected === 0 ? GlobalStyles.buttonFooterSelected : GlobalStyles.buttonFooter]} onPress={() => {
                    ...
                    <Icon2 name="payments" size={24} color={this.context.value.selected === 0 ? "white" : "#0052FE"} />
                    {
                ...
                <Pressable style={[this.context.value.selected === 1 ? GlobalStyles.buttonFooterSelected : GlobalStyles.buttonFooter]} onPress={() => {
                    ...
                    <Icon name="ethereum" size={24} color={this.context.value.selected === 1 ? "white" : "#0052FE"} />
                    {
                ...
                <Pressable style={[this.context.value.selected === 2 ? GlobalStyles.buttonFooterSelected : GlobalStyles.buttonFooter]} onPress={() => {
                    ...
                    <Icon2 name="attach-money" size={24} color={this.context.value.selected === 2 ? "white" : "#0052FE"} />
                    {
