...
import { NODE_ENV_NETWORK_APPNAME, contentColor, native, NODE_ENV_NETWORK_NAME, NODE_ENV_EXPLORER, NODE_ENV_NETWORK_RCP, tokens, tokensContracts, headerColor, NODE_ENV_USER_RCP, NODE_ENV_PASS_RCP } from "../../env"
    ...
    constructor(props) {
        ...
        this.connector = new WalletConnect({
            ...
            clientMeta: {
                ...
                icons: ["https://general-bucket-android.s3.amazonaws.com/miniLogoCP.png"], // Pending to REPO
                        ...
                        <View style={[GlobalStyles.mainSub, {}]}>
                            {
                                ...
                                <View style={{ flexDirection: "column", justifyContent: "space-between", alignItems: "center" }}>
                                    <Text style={[{ fontSize: 24, color: "black", marginVertical: 4 }]}>
                                        NFC or Scan
                                    </Text>
                                    ...
                                    <View style={{ flexDirection: "column", justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: contentColor, borderRadius: 10, width: "90%", marginTop: 10 }}>
                                        <Text style={[{ fontSize: 24, color: "black", marginVertical: 10 }]}>
