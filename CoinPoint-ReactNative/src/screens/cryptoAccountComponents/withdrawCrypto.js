            ...
            <View style={GlobalStyles.container}>
                ...
                }
                {
                    ...
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", alignItems: "center", paddingTop: 20 }]}>
                        <Text style={{ textAlign: "center", width: "100%", fontSize: 24, fontFamily: "Helvetica", color: "black" }}>
                            Scan your wallet {"\n"} (only manager)
                        </Text>
                        <QRCodeScanner
                ...
                }
                {
                    ...
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }]}>
                        <Text style={{ textAlign: "center", width: "100%", fontSize: 20, fontFamily: "Helvetica", color: "black" }}>
                            Celo Address:
                            {"\n"}
                            {
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", width: "100%", marginTop: 30 }}>
                            <Picker
                                ...
                                itemLabelStyle={[{ fontSize: 20, textAlign: "center", color: "black" }]}
                                selectedValueStyle={[{ fontSize: 20, textAlign: "center", color: "black" }]}
                            ...
                            />
                            <Text style={{ fontSize: 36, fontFamily: "Helvetica", color: "black" }}>
                                {
                            ...
                            <Pressable style={{ paddingTop: 6 }} onPress={() => this.maxSelected(this.state.token)}>
                                <Text style={{ fontSize: 24, fontFamily: "Helvetica", color: "black" }}>
                                    max{"   "}
                                </Text>
                            </Pressable>
                        </View>
