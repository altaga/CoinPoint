        ...
        return (
            <>
                <View style={GlobalStyles.container}>
                    <Header />
                    <Pressable style={{ position: "absolute", top: 9, left: 18 }} onPress={() => this.props.navigation.navigate('FiatTransactions')}>
                    ...
                    <Pressable onPress={() => this.props.navigation.navigate('WithdrawFiat')} style={{ position: "absolute", top: 9, right: 18 }}>
                        <View style={{ alignSelf: "center" }} >
                    ...
                    <View style={[GlobalStyles.main, { flexDirection: "column", alignItems: "center", paddingTop: 10 }]}>
                        <View>
                            ...
                            <Pressable onPress={() =>
                                ...
                                <Text style={{ textAlign: "center", color: "black", fontSize: 20, width: "100%" }}>
                                    {
