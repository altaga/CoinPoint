...
Welcome, this is our project for [Buidl the Future: A Global Hack for Web3](https://buidl-the-future.hackerearth.com/).

# IMPORTANT!

## Application:

Coinbase Wallet: [LINK](https://www.coinbase.com/wallet)

POS App APK: [LINK](./CoinPoint-ReactNative-Apk/app-release.apk)
